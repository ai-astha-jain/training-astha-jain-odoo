...
class ProductTemplate(models.Model):
    ...
    def _check_date(self):
        """method to check end date should be greater than start date."""
        for record in self:
    ...
    def mark_as_borrowed(self):
        ...
        self.activity_schedule(
            date_deadline=self.borrow_start_date + timedelta(days=10),
    ...
    def action_borrow_books(self):
        """Here I have add a python constraint which is not valid as
